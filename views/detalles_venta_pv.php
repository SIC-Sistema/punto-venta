      ...
      <div class="container">
                ...
                <li class="collection-item avatar">
                  ...
                  <p class="row col s12"><b>
                    <div class="col s12 m6">
                      ...
                      <div class="col s12"><b class="indigo-text">CLIENTE: </b><?php echo $Venta['id_cliente'];?></div>           
                    </div>
                    <div class="col s12 m6">
        ...
        <div class="row">
          <table>
            ...
            <tbody>
              <?php
              $sql_art =  mysqli_query($conn,"SELECT * FROM punto_venta_detalle_compra WHERE id_venta=$id_venta");
