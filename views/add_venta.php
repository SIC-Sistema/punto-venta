...
if (isset($_GET['id']) == false) {
    ...
    <head>
        ...
        if ($datos_user['ventas'] == 0) {
            ...
            <script>
                M.toast({
                    html: "Permiso denegado.", classes: "rounded"
                });
                M.toast({
                    html: "Contacta a un Administrador.", classes: "rounded"
                });
        ...
        <script>
            ...
            function buscar() {
                ...
                if (textoNombre == "" && textoCodigo == "") {
                    M.toast({
                        html: 'El campo Nombre y/o Codigo se encuentra vacío.', classes: 'rounded'
                    });
                } else {
            ...
            //FUNCION PARA OBTENER EL VALOR DEL ID DEL CLIENTE DESDE EL ARCHIVO control_clientes.php
            ...
            function modal_venta() {
                ...
                if (exist) {
                    M.toast({
                        html: '! NO SE PUEDE REALIZAR LA VENTA ¡', classes: 'rounded'
                    });
                    M.toast({
                        html: 'Alguno de los articulos superan su existencia', classes: 'rounded'
                    });
                } else {
    ...
    <body onload="tmp_articulos(0)">
        ...
        <div class="container"><br><br>
            ...
            <div class="row">
                <!-- BOTÓN PARA SELECCIONAR EL CLIENTE EN EL BUSCADOR DEL MODAL-->
                <a href="#modal_addCliente" class="waves-effect waves-light btn-small modal-trigger pink right">Agregar Cliente<i class="material-icons left">add</i></a>
                ...
                <div class="col s12 m9 l9 center">
                    <div class="input-field col s12 m3 l3">
                        ...
                        <select id="cliente" name="cliente" class="validate" onchange="javascript:showContent()">
                            ...
                            <option value="0" select>N/A</option>
                            <?php 
                            // REALIZAMOS LA CONSULTA A LA BASE DE DATOS MYSQL Y GUARDAMOS EN FORMARTO ARRAY EN UNA VARIABLE $consulta
                            $consulta = mysqli_query($conn,"SELECT * FROM `punto-venta_clientes` WHERE $id_cliente = id");
                    ...
                    <div id="resultado_info">
                        <h5><b>VENTA AL PUBLICO</b></h5>
                    </div>
                </div>
            </div>
            <hr>
            <div id="info_articulo">
                <div class="row">
                    ...
                    <div class="col s4 m2"><br>
                        ...
                        <a onclick="buscar();" class="waves-effect waves-light btn indigo lighten-5 indigo-text right"><b><i
                                    class="material-icons right">search</i>Buscar</b></a>
                    </div>
                </div>
            </div>
            <hr>
            <!-- BOTON QUE MANDA LLAMAR EL SCRIPT PARA QUE EL SCRIPT HAGA LO QUE LA FUNCION CONTENGA -->
            <a onclick="tmp_articulos(1);" class="waves-effect waves-light btn pink right"><i
                    class="material-icons right">add</i>Agregar Producto</a>
            <a onclick="pausar_venta(<?php echo $id; ?>);"
                class="waves-effect waves-light btn indigo lighten-5 indigo-text"><b><i
                        class="material-icons right">pause</i>Pausar Venta</b></a>
