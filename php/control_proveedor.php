            ...
            while($proveedor = mysqli_fetch_array($consulta)) {
                $contenido .= '			
		          <tr>
		            ...
		            <td><form method="post" action="../views/editar_proveedor.php"><input id="no_proveedor" name="no_proveedor" type="hidden" value="'.$proveedor['id'].'"><button class="btn-floating btn-tiny waves-effect waves-light pink"><i class="material-icons">edit</i></button></form></td>
